...
ui_path = r'C:\2025ncc\2025ncc\#34_drawingboard\그림판3.ui'
...
class WindowClass(QMainWindow, form_class):
    def __init__(self):
        ...
        self.btn_white.clicked.connect(self.btn_clicked)
        self.btn_white.setStyleSheet('background:white')
